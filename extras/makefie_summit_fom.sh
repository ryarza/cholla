...
CUSTOM_DOMAIN_PFFT = -DCUSTOM_DOMAIN_PFFT
# PRINT_PFFT_DOMAIN = -DPRINT_PFFT_DOMAIN
...
FLAGS_GRAVITY = $(GRAVITY) $(POISSON_SOLVER) $(CUSTOM_DOMAIN_PFFT) $(SET_MPI_GRID) $(PRINT_PFFT_DOMAIN) $(GRAVITY_COUPLE) $(GRAVITY_ENERGY_COUPLE) $(OUTPUT_POTENTIAL) $(GRAVITY_INT) $(GRAVITY_GRADIENT)

...
void Grid3D::Read_Grid_HDF5(hid_t file_id, struct parameters P)
{
  ...
  if (H.nx>1 && H.ny>1 && H.nz>1) {
    ...
    nz_0 = H.PFFT_Domain.nz_local_cholla;
    
    nx_pfft = H.PFFT_Domain.nx_local;
    ...
    for (k=0; k<H.nz_real; k++) {
      for (j=0; j<H.ny_real; j++) {
        for (i=0; i<H.nx_real; i++) {
          ...
          while( i_0 < 0 ) i_0 += ny_0;
           while( i_0 >= nx_0 ) i_0 -= ny_0;
          
           while( j_0 < 0 ) j_0 += ny_0;
           while( j_0 >= ny_0 ) j_0 -= ny_0;
                    
           while( k_0 < 0 ) k_0 += nz_0;
           while( k_0 >= nz_0 ) k_0 -= nz_0;

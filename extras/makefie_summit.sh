...
FLAGS_GRAVITY = $(GRAVITY) $(POISSON_SOLVER) $(CUSTOM_DOMAIN_PFFT) $(PRINT_PFFT_DOMAIN) $(GRAVITY_COUPLE) $(GRAVITY_ENERGY_COUPLE) $(OUTPUT_POTENTIAL) $(GRAVITY_INT) $(GRAVITY_GRADIENT)
